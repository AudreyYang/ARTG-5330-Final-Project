...
var Particle = function (name, sum, category) {
    ...
    this.pos.mult(1000);
    this.pos.set(this.pos.x + width / 2 + 100, this.pos.y + height / 2);
...
var investorParticle = function (name, sum, investor) {
    ...
    this.draw = function () {
        ...
        if (companiesToDisplay.length == 1) {
            ...
            ellipse(this.pos.x + 80, this.pos.y - 25, this.radius * 6, this.radius * 6);
            fill(0, 0, 40);
            noStroke();
            textSize(8);
            text(this.invename, this.pos.x + 80, this.pos.y - 45);
        }
    }
